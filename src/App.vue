<template>
  <div id="app">
    ...
    <!-- 사용자 관리 모달 -->
    <UserManagementModal 
      v-model="showUserManagementModal"
      @show-error-log-detail="showErrorLogDetail"
    />
    ...
    <div class="main-content">
      ...
      <div class="other-results-area">
        <!-- 음악 추천 기능 -->
        <!-- MusicRecommendation component not found - commented out -->
...
import SignupModal from './modules/auth/components/SignupModal.vue'
import VocManagement from './modules/voc/components/VocManagement.vue'
import TopButtons from './modules/layout/components/TopButtons.vue'
import DocsLibraryModal from './modules/shared/components/modals/DocsLibraryModal.vue'
import DocViewerModal from './modules/shared/components/modals/DocViewerModal.vue'
import MCPGuideModal from './modules/shared/components/modals/MCPGuideModal.vue'
import ErrorLogDetailModal from './modules/shared/components/modals/ErrorLogDetailModal.vue'
import EconomyAlarmModal from './modules/shared/components/modals/EconomyAlarmModal.vue'
import AIArticleSearch from './modules/news/components/AIArticleSearch.vue'
import EconomyArticleSearch from './modules/news/components/EconomyArticleSearch.vue'
import NewsCollection from './modules/news/components/NewsCollection.vue'
// MusicRecommendation component not found - removed from imports
import RadioHistory from './modules/music-book/components/RadioHistory.vue'
import BookRecommendation from './modules/music-book/components/BookRecommendation.vue'
import BookHistory from './modules/music-book/components/BookHistory.vue'
import ScreenValidation from './modules/ai-tools/components/ScreenValidation.vue'
import SQLQueryAnalysis from './modules/ai-tools/components/SQLQueryAnalysis.vue'
import ErrorLogAnalysis from './modules/ai-tools/components/ErrorLogAnalysis.vue'
import TableImpactAnalysis from './modules/ai-tools/components/TableImpactAnalysis.vue'
...
/* MCP 가이드 모달 - 공통 모달 스타일은 styles/modules/modal.css로 이동됨 */
